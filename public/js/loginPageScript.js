...
loginButton.addEventListener("click", async () => {
  if (codePersoneli.value) {
    const loginRequest = await axios.post("/duty/?action=login", {
...
logoutButton.addEventListener("click", async () => {
  if (codePersoneli.value) {
    const logoutRequest = await axios.post("/duty/?action=logout", {
      codePersoneli: codePersoneli.value,
    });
...
passwordSubmitButton.addEventListener("click", async () => {
  ...
  const passwordValidation = await axios.post("/duty/?action=password", {
